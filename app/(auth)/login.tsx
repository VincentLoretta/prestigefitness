...
export default function LoginScreen() {
  ...
  async function onSubmit() {
    ...
    if (!password.length) return Alert.alert("Missing password", "Please enter your password.");
    ...
    <SafeAreaView style={s.container}>
      ...
      >
        <View style={s.header}>
          ...
          <Text style={s.subtitle}>Log in to continue your streaks & XP.</Text>
        </View>
        ...
        <View style={s.form}>
          ...
          >
            <Text style={s.btnPrimaryText}>{authLoading ? "Logging in…" : "Log in"}</Text>
          </TouchableOpacity>
          ...
          <Link href="/(auth)/register" asChild>
            <TouchableOpacity style={[s.btn, s.btnGhost]}>
              <Text style={s.btnGhostText}>Need an account? Register</Text>
            </TouchableOpacity>
          </Link>
        </View>
      </KeyboardAvoidingView>
